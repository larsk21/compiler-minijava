...
public class DumbAllocatorTest {
    ...
    public void testCompareToFirm() {
        ...
        expected.add("movl %ebx, -64(%rbp) # spill for @7");
        expected.add("movl -56(%rbp), %edi # load @6 as arg 0");
        expected.add("movl -64(%rbp), %esi # load @7 as arg 1");
        ...
        expected.add("movq -48(%rbp), %rbx # get divisor");
    ...
    public void testComplexProgram() {
        ...
        expected.add("movl %ebx, -272(%rbp) # spill for @35");
        ...
        expected.add("movq %rbx, -264(%rbp) # ...and spill to target");
        expected.add("movq -264(%rbp), %rbx # reload for @34 [overwrite]");
        ...
        expected.add("movq %rbx, -88(%rbp) # spill for @11");
        expected.add("movq -80(%rbp), %rax # get dividend");
        expected.add("movq -88(%rbp), %rbx # get divisor");
        expected.add("cqto # sign extension to octoword");
        expected.add("idivq %rbx");
        expected.add("movq %rax, -280(%rbp) # spill for @36");
        ...
        expected.add("movq %rbx, -128(%rbp) # spill for @16");
        expected.add("movq -120(%rbp), %rax # get dividend");
        expected.add("movq -128(%rbp), %rbx # get divisor");
        expected.add("cqto # sign extension to octoword");
        expected.add("idivq %rbx");
        expected.add("movq %rax, -288(%rbp) # spill for @37");
        ...
        expected.add("movq $2, %rbx");
        expected.add("movq %rbx, -184(%rbp) # spill for @23");
        expected.add("movq -176(%rbp), %rax # get dividend");
        expected.add("movq -184(%rbp), %rbx # get divisor");
        expected.add("cqto # sign extension to octoword");
        expected.add("idivq %rbx");
        expected.add("movq %rax, -296(%rbp) # spill for @38");
        ...
        expected.add("movq $3, %rbx");
        expected.add("movq %rbx, -224(%rbp) # spill for @28");
        expected.add("movq -216(%rbp), %rax # get dividend");
        expected.add("movq -224(%rbp), %rbx # get divisor");
        expected.add("cqto # sign extension to octoword");
        expected.add("idivq %rbx");
        expected.add("movq %rax, -304(%rbp) # spill for @39");
        ...
        expected.add("movl %ebx, -248(%rbp) # spill for @31");
        expected.add("movl -248(%rbp), %ebx # load to temporary...");
        expected.add("movl %ebx, -32(%rbp) # ...and spill to target");
        expected.add("jmp .L1");

        expected.add(".L3:");
        expected.add("movl -272(%rbp), %ebx # reload for @35 [overwrite]");
        expected.add("subl $1, %ebx");
        expected.add("movl %ebx, -256(%rbp) # spill for @32");
        expected.add("movl -256(%rbp), %edi # load @32 as arg 0");
        expected.add("call print@PLT");
