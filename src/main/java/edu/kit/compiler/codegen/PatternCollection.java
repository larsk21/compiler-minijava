...
public class PatternCollection implements Pattern<InstructionMatch> {
    ...
    public PatternCollection() {
        map = Map.ofEntries(
                ...
                Map.entry(iro_Shr, BinaryInstructionPattern.of(iro_Shr, "shr", REG, IMM8, 0, false)),
                Map.entry(iro_Shrs, BinaryInstructionPattern.of(iro_Shrs, "sar", REG, IMM8, 0, false)),
